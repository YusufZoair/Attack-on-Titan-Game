...
public class Milestone1PrivateTests {
	...
	@Test
	public void testWallInstanceVariableCurrentHealthGetterLogic()
	...
	@Test
	public void testLaneInstanceVariableDangerLevelIsPrivate()
	...
	@Test
	public void testInvalidCSVFormatInputLineGetterLogic()
			throws NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException {
	...
	public void testbaseHealthFinalAttribute() throws NoSuchFieldException, SecurityException, ClassNotFoundException {
		...
		assertTrue("The baseHealth attribute should be final",
				java.lang.reflect.Modifier.isFinal(baseHealthField.getModifiers()));
	}

	@Test(timeout = 100)
	public void testbaseHealthPrivateAttribute()
			throws NoSuchFieldException, SecurityException, ClassNotFoundException {
		Field baseHealthField = Class.forName(titanClassPath).getDeclaredField("baseHealth");
		assertTrue("The baseHealth attribute should be private",
				java.lang.reflect.Modifier.isPrivate(baseHealthField.getModifiers()));
	}
	...
	@Test(timeout = 100)
	public void testTitanCodeFinalAttributeInArmoredClass()
			throws NoSuchFieldException, SecurityException, ClassNotFoundException {
	...
	@Test(timeout = 100)
	public void testTitanCodePublicAttributeInColossalClass()
			throws NoSuchFieldException, SecurityException, ClassNotFoundException {
	...
	@Test(timeout = 100)
	public void testCompareToGreaterThanLogic() throws ClassNotFoundException, NoSuchMethodException, SecurityException,
	...
	@Test(timeout = 100)
	public void testAttributeWeaponCodeIsFinalInClassPiercingCannon()
			throws NoSuchFieldException, SecurityException, ClassNotFoundException {
	...
	@Test(timeout = 100)
	public void testAttributeMinRangeIsFinalInClassVolleySpreadCannon()
			throws NoSuchFieldException, SecurityException, ClassNotFoundException {
		Field minRangeField = Class.forName(volleySpreadCannonPath).getDeclaredField("minRange");
		assertTrue("The minRange attribute should be final",
				java.lang.reflect.Modifier.isFinal(minRangeField.getModifiers()));
	}
	...
	@Test(timeout = 100)
	public void testInstanceVariableFactoryResponseRemainingResourcesGetterLogic() throws Exception {
	...
	public void testInstanceVariableBattlePhaseBattleGetter() throws ClassNotFoundException {
		testGetterMethodExistsInClass(Class.forName(battlePath), "getBattlePhase", Class.forName(battlePhasePath),
				true);
	}
	...
	public void testInstanceVariableWeaponFactoryBattleSetter() throws ClassNotFoundException {
		testSetterMethodExistsInClass(Class.forName(battlePath), "setWeaponFactory", Class.forName(weaponFactoryPath),
				false);
	}
	...
	public void testConstructorInitializationBattleInt() throws Exception {
		...
		String[] names = { "numberOfTurns", "battlePhase", "numberOfTitansPerTurn", "score", "titanSpawnDistance",
				"resourcesGathered" };
	...
	public void testConstructorInitializationClassTitanRegistry() throws Exception {
		...
		Object tR = constructor.newInstance(randomCode, randomBaseHealth, randomBaseDmg, randomHIM, randomSpeed,
				randomRV, randomDL);
		String[] names = { "code", "baseHealth", "baseDamage", "heightInMeters", "speed", "resourcesValue",
				"dangerLevel" };
	...
	public void testLoadMaxWeaponRegistryCorrectly() {
		try {
			...
			assertTrue("incorrect damage in readWeaponRegistry",
					checkWREqual(constructor2.newInstance(8, 45, 35, "Mjolnir", 10, 60), o, "maxRange"));

			o = hashMap.get(9);
			assertTrue("incorrect damage in readWeaponRegistry",
					checkWREqual(constructor2.newInstance(9, 55, 35, "verybigweapon", 20, 70), o, "maxRange"));
	...
	@Test(timeout = 100)
	public void testAttributeWeaponCodeIsFinalInClassVolleySpreadCannon()
			throws NoSuchFieldException, SecurityException, ClassNotFoundException {
	...
	@Test(timeout = 100)
	public void testTitanCodePublicAttributeInArmoredClass()
			throws NoSuchFieldException, SecurityException, ClassNotFoundException {
		Field titanCodeField = Class.forName(ArmoredTitanClassPath).getDeclaredField("TITAN_CODE");
		assertTrue("The TITAN_CODE attribute should be public",
				java.lang.reflect.Modifier.isPublic(titanCodeField.getModifiers()));
	...
	private void testGetterMethodLogicForMSG(Object createdObject, String varName, String expectedValue)
			throws IllegalArgumentException, IllegalAccessException, NoSuchMethodException, SecurityException,
