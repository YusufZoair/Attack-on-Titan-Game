...
public class DisplayArmored extends StackPane {

    private ArmoredTitan titan;
    private Tooltip tooltip;

    public DisplayArmored(ArmoredTitan titan) {
        this.titan = titan;
        ...
        ImageView imageView = new ImageView(new Image("file:Game assets/Titan 2.png"));
        ...
        // Create label for "Armored Titan"
        Label label = new Label("Armored Titan");

        // Create an ImageView for the tooltip image
        ImageView tooltipImageView = new ImageView(new Image("file:Game assets/Titan 2.png"));
    ...
    public ArmoredTitan getTitan() {
        return titan;
    }

    public void setTitan(ArmoredTitan titan) {
        this.titan = titan;
    }
